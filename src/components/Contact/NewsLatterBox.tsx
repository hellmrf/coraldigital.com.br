...
const NewsLatterBox = () => {
  ...
  // Use semantic colors based on the theme
  const primaryColor = theme === "light" ? "#FF6F61" : "#FF6F61"; // Using our coral color
  const whiteColor = "#F5F5F5"; // Using our semantic white

  return (
    <div className="relative z-10 rounded-xs bg-surface p-8 shadow-three dark:bg-background-dark sm:p-11 lg:p-8 xl:p-11">
      <h3 className="mb-4 text-2xl font-bold leading-tight text-text dark:text-text-dark">
        Subscribe to receive future updates
      </h3>
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-text-dark dark:border-opacity-25">
      ...
      <div>
        <input
          ...
          className="border-stroke mb-4 w-full rounded-xs border bg-gray-100 px-6 py-3 text-base text-body-color outline-hidden focus:border-primary dark:border-transparent dark:bg-gray-800 dark:text-body-color-dark dark:shadow-two dark:focus:border-primary dark:focus:shadow-none"
        />
        <input
          type="email"
          name="email"
        ...
        <span className="absolute left-2 top-7">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop
                  stopColor={theme === "light" ? "#FF6F61" : "#fff"}
                  stopOpacity="0.62"
                />
                <stop
                  offset="1"
